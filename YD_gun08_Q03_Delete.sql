...
WHERE isim LIKE '%a%';
 ...
 /*  
========================  ORNEK  ========================
 veli isminin uzunluğu 3 harf veya daha fazla olanlardan 3 puan silin
=========================================================
 */

UPDATE kursiyer
SET yazili_notu = yazili_notu - 3
WHERE LENGTH(veli_isim) > 3;
...
SAVEPOINT database_rollback_sonrasi_durum;
...
-- savepoint noktasina geri donun
ROLLBACK TO database_rollback_sonrasi_durum;
...
-- Error Code: 1146. Table 'team161.dereceler' doesn't exist	0.0025 sec
