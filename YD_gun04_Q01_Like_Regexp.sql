...
-- calisanlar tablosundan ismi Ayse olanlarin bilgilerini listeleyin
...
-- bu sorgu ismi bire-bir "Ayse" olan kayitlari getirir
-- eger gercek hayatta beklenecegi gibi
-- ismi sadece "Ayse" olanlari degil,
-- isminin icinde "Ayse" gecenleri listelemek istersek
...
SELECT kelime 
FROM kelimeler 
WHERE kelime REGEXP 'ot|at';


-- isminde b,c veya d harfi olanlar
SELECT kelime 
FROM kelimeler 
WHERE kelime REGEXP 'b|c|d';
