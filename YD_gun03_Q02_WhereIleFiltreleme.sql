...
FROM personel;
  ...
  /*  
========================  ORNEK  ========================
 personel tablosundan adi ve lastname sutunlarini görüntüleyin.
=========================================================
 */
...
*/
 ...
 /*  
========================  ORNEK  ========================
kitaplar tablosunda Lev Tolstoy'a ait kitapların 
ismini, yayın tarihini ve kategorisini listeleyin
=========================================================
 */
...
-- MySQL kayitlar icin case sensitive degildir
-- yani buyuk kucuk harf duyarliligi YOKTUR


 /*  
========================  ORNEK  ========================
kitaplar tablosunda turu macera olan kitapların 
kitap ve yazar adlarını listeleyin
=========================================================
 */
...
/*  
========================  ORNEK  ========================
İçinde id, isim, soy isim, yas, şehir sütunları bulunan 
people isimli bir tablo oluşturun 
